...
<form name="form1" method="post" action="save_Update2.php">
  ...
  <?php echo "<td><a href='save_Delete2.php' onclick=\"return confirm('Do you want to delete this record? !!!')\" style='color: black;margin-left: 575px;background: Salmon; text-decoration: none;font-size:30px;padding: 10px 10px 10px 10px;'>CANCEL</a></td> ";?>
