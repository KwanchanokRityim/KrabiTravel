...
<form name="form2" method="post" action="check_Update.php">
  <h2 style="text-align:center;background: Lavender;padding: 10px 10px 10px 10px;">Update <br></h2>
...
<br>
  ...
  <br>
  <input type="submit" name="save" value="view" style='color: black;margin-left: 575px;background: #b3d9ff; text-decoration: none;font-size:20px;padding: 10px 10px 10px 10px;'>
</form>
</body>
</html>